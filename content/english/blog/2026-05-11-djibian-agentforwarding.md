...
4. **sshwgpg**'s *--no-gpg* or *--no-ssh* options.[^sshwgpg-options]
...
[^sshwgpg-options]:
    ...
    - *--dry-run* : do not actually exec ssh — only print the ssh command that would have been run.
