---
title: "2025 S30 Rapport Hebdomadaire"
lang: fr
date: 2025-07-22T21:30:00+02:00
draft: false
...
### Ordre du jour pour le prochain conseil, mardi 29 juillet 2025 à **21h00**, en visio sur <https://cloud.foopgp.org/call/4du5irxe>
...
- Explications des derniers graphiques 3D:
  ...
  - [Gains in € depending on investment in Ɉ and time](https://www.math3d.org/VHvPcDNBY9) .
...
- eSIM vulnerability discovered. That's gonna be a rough one to fix if it is genuinely exploitable.
  ...
  <https://infosec.exchange/@Sempf/114855160108103941>
- Canicule : Firefox croule sous les rapports de crash causés par ces processeurs. Un développeur de Firefox alerte <https://www.lesnumeriques.com/cpu-processeur/canicule-firefox-croule-sous-les-rapports-de-crash-causes-par-ces-processeurs-n239996.html>

  <https://mamot.fr/@Mozilla/114875810524979415>
- Il faut rester vigilant sur ce sujet : une étude indique que les outils d'#IA de codage ralentissent les développeurs tout en leur donnant l'illusion d'être plus rapides : ils ont mis 19 % plus de temps à accomplir les tâches de codage
  ...
  <https://piaille.fr/@gregofabre/114873384511029516>

### Activité récente

#### Au cœur de la réunion

- Logistique autour du contrat de Sebastien (Piseb).
- Débrayage estival
- Attente publication du compte-rendu de l'AG du 20 juillet
- Explications des derniers graphiques 3D:
  - [Gains in € depending on investment in Ɉ and time](https://www.math3d.org/VHvPcDNBY9)
