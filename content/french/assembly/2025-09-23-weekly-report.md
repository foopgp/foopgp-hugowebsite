---
title: "2025 S39 Rapport Hebdomadaire"
lang: fr
date: 2025-09-23T21:30:00+02:00
draft: true
...
***Présents :*** *Jean-Jacques B, Laurent C., François R., piseb, Didier L, François F.*

### Ordre du jour pour le prochain conseil, mardi 30 Septembre 2025 à **21h00**, en visio sur <https://cloud.foopgp.org/call/4du5irxe>
...
- l'UE étend son réseau de puissance quantique : <https://www.linformaticien.com/magazine/infra/63890-l-ue-etend-son-reseau-de-puissance-quantique.html>
- Des services de deepfakes de moins en moins cher : <https://www.linformaticien.com/magazine/cybersecurite/63887-des-services-de-deepfakes-de-moins-en-moins-chers.html>
- Lookout présente un nouvel outil pour lutter contre le smishing : <https://www.linformaticien.com/magazine/cybersecurite/63883-lookout-presente-un-nouvel-outil-pour-lutter-contre-le-smishing.html>
- Un ransomware à l'origine des perturbations dans les aéroports européens : <https://www.linformaticien.com/magazine/cybersecurite/63881-un-ransomware-a-l-origine-de-perturbations-dans-des-aeroports-europeens.html>
- Cyberattaque contre Jaguar Land Rover : <https://www.linformaticien.com/magazine/cybersecurite/63872-cyberattaque-contre-jaguar-land-rover-les-usines-a-l-arret.html>
- La Chine interdit à ses entreprise d'acheter du Nvidia : <https://www.linformaticien.com/magazine/tendances/941-ia/63863-la-chine-interdit-a-ses-entreprises-d-acheter-du-nvidia.html>
- On avait déjà parlé du développeur de libxml2 qui avait déjà pété un câble au mois de juin : <https://sebsauvage.net/links/?58FWPQ>
  ...
  <https://framapiaf.org/@sebsauvage/115209781650437667>
- Amadeus (réservation de voyage) teste un portefeuille numérique : <https://www.linformaticien.com/magazine/cybersecurite/63853-amadeus-teste-un-portefeuille-numerique.html>
- 

### Au cœur de la réunion

- Didier revenant sur le principe de création monétaire par dividende universelle souhaite construire et proposer une résolution d'Assemblée Générale pour qu'une partie de la création de nouveaux djis aillent directement sur un (ou plusieurs) compte spécifique dédié "au commun".
- Discussions sur la mise en commun d'actif foncier via l'association. Ainsi nous serions tous copropriétaires de ce commun au travers de nos djis.
- Djibian avance, et a été installé chez 2 "client(e)s" (et bêta-testeurs ^^ ).
- Deadline pour transaction "onchain" de djis au travers de yubikeys/OpenPGP/git : 2 octobre 2025, sur la nouvelle "blockchain"(dépôts git, après celui de POC).
- Commande sticker et roll-up.
...
- Peaufinage de l'ISO et des processus (développement, comptabilité, etc.).
